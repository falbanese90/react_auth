                    ...
                    <div className={"col-md-4 col-sm-11 col-xs-11"}>
                        <div className={"footer-text pull-left"}>
                             <div className={"d-flex"}>
                                 <h1 className={"font-weight-bold mr-2 px-3"} style={{color:'000000', backgroundColor:'#fec400'}} > A </h1>
                                 <h1 style={{color: '#fec400'}}>&nbsp;l0ha</h1>
                             </div>
                             <p className={"card-text"}>We came, we saw we conquered..</p>
